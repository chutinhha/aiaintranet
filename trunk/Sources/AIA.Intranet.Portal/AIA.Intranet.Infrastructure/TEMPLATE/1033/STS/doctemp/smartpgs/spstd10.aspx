				...
				<tr>
					<td valign="top" style="padding:0">
						<table cellpadding="4" cellspacing="0" border="0" width="100%" height="100%">
							...
							<tr>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%" width="25%"> <WebPartPages:WebPartZone runat="server" Title="loc:CenterLeftColumn" ID="CenterLeftColumn" FrameType="TitleBarOnly"/> </td>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%" width="50%"> <WebPartPages:WebPartZone runat="server" Title="loc:CenterColumn" ID="CenterColumn" FrameType="TitleBarOnly"/> </td>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%" width="25%"> <WebPartPages:WebPartZone runat="server" Title="loc:CenterRightColumn" ID="CenterRightColumn" FrameType="TitleBarOnly"/> </td>
							</tr>
							<tr>
