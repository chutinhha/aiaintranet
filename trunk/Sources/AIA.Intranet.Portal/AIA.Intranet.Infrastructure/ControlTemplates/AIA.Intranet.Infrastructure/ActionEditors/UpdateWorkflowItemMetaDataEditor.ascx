...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateWorkflowItemMetaDataEditor.ascx.cs" Inherits="AIA.Intranet.Infrastructure.Controls.UpdateWorkflowItemMetaDataEditor" %>
