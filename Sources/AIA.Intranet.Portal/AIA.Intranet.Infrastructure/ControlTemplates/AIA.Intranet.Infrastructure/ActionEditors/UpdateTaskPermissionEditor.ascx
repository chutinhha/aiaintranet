...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateTaskPermissionEditor.ascx.cs" Inherits="AIA.Intranet.Infrastructure.Controls.UpdateTaskPermissionEditor" %>
